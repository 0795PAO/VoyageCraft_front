...
const Footer = () => {
    return (
        <footer className="bg-primary p-4 w-full mt-auto">
            <div className="container mx-auto flex items-center justify-between">
                <a href="https://github.com/0795PAO/VoyageCraft_front" className="flex items-center text-white px-4 py-2 hover:bg-blue-700 rounded">
                ...
                <a href="#" className="block text-white px-4 py-2 hover:bg-blue-700 rounded">Privacy</a>
                <a href="#" className="block text-white px-4 py-2 hover:bg-blue-700 rounded">Cookies</a>
                <a href="#" className="block text-white px-4 py-2 hover:bg-blue-700 rounded">Contact</a>
            </div>
        </footer>
    );
};
